...
class LearningRateDecayOptimizerConstructor(DefaultOptimizerConstructor):
    ...
    def add_params(self, params, module, **kwargs):
        ...
        for name, param in module.named_parameters():
            ...
            if (
                'layer_wise' in decay_type
                and 'ConvNeXt' in module.backbone.__class__.__name__
            ):
                ...
                'layer_wise' in decay_type
                or decay_type == 'stage_wise'
                and 'ConvNeXt' not in module.backbone.__class__.__name__
            ):
